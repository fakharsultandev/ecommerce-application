...
const ProductHandlersHeader = ({ handleViewType }) => (
  <div className="flex justify-between items-center w-full mb-8 rounded-lg gap-1 ">
    <button className="border p-2 px-4 rounded-lg flex items-center gap-2 transition-all duration-300 ease-in-out hover:bg-gray-100">
      <AdjustmentsVerticalIcon className="size-5" /> Setting
    </button>
